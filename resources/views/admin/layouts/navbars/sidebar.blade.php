<div class="sidebar">
    <div class="sidebar-wrapper">
        ...
        <ul class="nav">
            ...
            <li
            {{-- @if ($pageSlug == 'icons') class="active " @endif --}}
            >
            ...
            <li
            {{-- @if ($pageSlug == 'tables') class="active " @endif --}}
            >
            ...
            <li
            {{-- @if ($pageSlug == 'rtl') class="active " @endif --}}
            >
                <a href="{{ route('admin.pages.rtl') }}">
                    <i class="tim-icons icon-world"></i>
                    <p>{{ __('RTL Support') }}</p>
                </a>
            </li>
            <li
            {{-- class=" {{ $pageSlug == 'upgrade' ? 'active' : '' }} bg-info" --}}
            >
            ...
            <li>
                ...
                <div class="collapse show" id="modul-pembelajaran">
                    <ul class="nav pl-4">
                        <li
                        {{-- @if ($pageSlug == 'modulPembelajaran') class="active " @endif --}}
                        >
